...
const PATTERN_GROUPS = {
  ...
  loxleyTemp: ['**/.loxley/data/**', '**/.loxley/config/**', '**/database/**'],
} as const
...
class Cleaner {
  ...
  private setupSkips(): void {
    ...
    this.skipPatterns.push('packages/loxley-contracts/artifacts/contracts/**/*.json')
  }
  ...
  private getPatterns(): string[] {
    ...
    // LoxleyTemp is always included.
    patterns.push(...PATTERN_GROUPS.loxleyTemp)
    return patterns
  }

...
const PATTERN_GROUPS = {
  ...
  brackenTemp: ['**/.bracken/data/**', '**/.bracken/config/**', '**/database/**'],
} as const
...
class Cleaner {
  ...
  private setupSkips(): void {
    ...
    this.skipPatterns.push('packages/bracken-contracts/artifacts/contracts/**/*.json')
  }
  ...
  private getPatterns(): string[] {
    ...
    // BrackenTemp is always included.
    patterns.push(...PATTERN_GROUPS.brackenTemp)
    return patterns
  }

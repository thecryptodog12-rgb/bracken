...
#   3. packages/bracken-contracts/scripts/utils.ts   (BFV_DKG_H / BFV_THRESHOLD_T)
#   4. crates/zk-helpers/src/ciphernodes_committee.rs (committee enum values, single source)
#   5. packages/bracken-contracts/contracts/lib/ActiveCryptoConfig.sol
#
...
UTILS_TS="packages/bracken-contracts/scripts/utils.ts"
COMMITTEE_RS="crates/zk-helpers/src/ciphernodes_committee.rs"
ACTIVE_SOL="packages/bracken-contracts/contracts/lib/ActiveCryptoConfig.sol"

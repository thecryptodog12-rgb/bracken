#!/usr/bin/env bash
# Sync packages/bracken-contracts/test/fixtures/bfv_vk_binding/folded_artifacts.json
...
FIXTURE="${REPO_ROOT}/packages/bracken-contracts/test/fixtures/bfv_vk_binding/folded_artifacts.json"

#!/usr/bin/env bash
# Sync packages/loxley-contracts/test/fixtures/bfv_vk_binding/folded_artifacts.json
...
FIXTURE="${REPO_ROOT}/packages/loxley-contracts/test/fixtures/bfv_vk_binding/folded_artifacts.json"

 ...
 * default `computeProviderParams` (see `tasks/loxley.ts`). When ZK verification is enabled, `deployLoxley` still
 * registers the real BFV verifiers on Loxley instead of these mocks.
 */

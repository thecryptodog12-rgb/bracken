...
Common flags:
  ...
  --config <file>           Defaults to packages/loxley-contracts/deploy/sale/<network>-sale.config.json
...
Examples:
  ...
  pnpm sale --network mainnet --action prepare --safe 0xSafe --config packages/loxley-contracts/deploy/sale/mainnet-sale.config.json
  pnpm sale --network mainnet --action plan --config packages/loxley-contracts/deploy/sale/mainnet-sale.config.json
  pnpm sale --network mainnet --action deploy --config packages/loxley-contracts/deploy/sale/mainnet-sale.config.json --propose-safe
  pnpm sale --network mainnet --action propose-safe --config packages/loxley-contracts/deploy/sale/mainnet-sale.config.json
`);
}

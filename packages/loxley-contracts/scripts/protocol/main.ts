...
Examples:
  ...
  pnpm protocol --network sepolia --action propose-safe --config packages/loxley-contracts/deploy/protocol/sepolia-protocol.config.json
...
Flags:
  --sync-integration-config  Also update tests/integration/loxley.config.yaml
  ...
  --fold 0x...               Fill a zero LOXLEY placeholder

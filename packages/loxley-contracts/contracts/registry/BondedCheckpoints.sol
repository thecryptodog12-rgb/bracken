 ...
 *
 * @dev Bonded LOXLEY is transferred to the registry, which never delegates it. Under ERC20Votes an
 ...
 *
 * Timepoints are `block.timestamp`, matching `LoxleyToken`'s ERC-6372 `mode=timestamp` clock.

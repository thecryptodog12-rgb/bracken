...
/**
 * @title LoxleyTicketToken (tLOXLEY)
    ...
    ReentrancyGuard
{
    ...
    /**
     * @notice Initializes the Loxley Ticket Token with name "Loxley Ticket Token" and symbol "tLOXLEY"
    ...
    constructor(
        ...
        ERC20("Loxley Ticket Token", "tLOXLEY")

...
/**
 * @title LoxleyToken
 * @notice The governance and utility token for the Loxley protocol, with
 *         wallet-level lock enforcement designed around the Uniswap CCA
 *         distribution flow.
 *
 */
contract LoxleyToken is
    ERC20,
    ERC20Permit,
    ERC20Votes,
    Ownable2Step,
    AccessControl
{
    ...
    /// @notice EIP-6372 clock — block.timestamp, aligned with other Loxley
    ///         contracts.

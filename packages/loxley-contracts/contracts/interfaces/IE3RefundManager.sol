...
interface IE3RefundManager {
    ...
    /// @notice Emitted when the Loxley address is set
    ...
    error InvalidFailureReason(ILoxley.FailureReason reason);
    ...
    /// @dev Only Loxley may call this, exactly once, during request creation.
    ...
    /// @dev Only the Loxley contract assigned to the E3 may call this once.

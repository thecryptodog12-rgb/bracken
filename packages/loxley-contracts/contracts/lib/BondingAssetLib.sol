...
library BondingAssetLib {
    ...
    function availableTickets(
        ...
        return
            LoxleyTicketToken(ticketTokenAddress).balanceOf(operator) /
            ticketPrice;
    }
    ...
    function ticketBalance(
        ...
        return LoxleyTicketToken(ticketTokenAddress).balanceOf(operator);
    }
    ...
    function ticketBalanceAt(
        ...
        return
            LoxleyTicketToken(ticketTokenAddress).getPastVotes(
                operator,
                timepoint
            );
    }
    ...
    function validateBondingAssetConfig(
        ...
        emit IBondingRegistry.BondingAssetConfigUpdated(
            LoxleyTicketToken(config.ticketToken),
    ...
    function _validateTicketAsset(
        ...
        LoxleyTicketToken token = LoxleyTicketToken(current);

...
Shared build tooling configuration for the Loxley monorepo. This is an **internal package** — it
...
```json
{
  "extends": "@loxley/config/tsconfig.json",
  "compilerOptions": {
    "outDir": "dist"
  },
  "include": ["src"]
...
```ts
export { default } from '@loxley/config/tsup'
```

...
import { CiphernodeRegistryOwnable__factory } from '@loxley/contracts/types'
import type { Log, PublicClient } from 'viem'
import { afterEach, describe, expect, it, vi } from 'vitest'

import { EventListener } from '../src/events/event-listener'
import { RegistryEventType, type LoxleyEvent } from '../src/events/types'
...
describe('RegistryEventType', () => {
  ...
  it('preserves the request-time ticket price', () => {
    ...
    const event: LoxleyEvent<RegistryEventType.COMMITTEE_REQUESTED> = {

 ...
 * default `computeProviderParams` (see `tasks/bracken.ts`). When ZK verification is enabled, `deployBracken` still
 * registers the real BFV verifiers on Bracken instead of these mocks.
 */

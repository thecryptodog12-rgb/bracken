...
function applyPrepareOverrides(config: SaleConfigFile): void {
  ...
  const presaleStart =
    optionalTimestampInput("presale-start", "BRACKEN_CCA_START") ??
    optionalTimestampInput("cca-start-timestamp", "BRACKEN_CCA_START");
  ...
  const auctionEnd =
    optionalTimestampInput("auction-end", "BRACKEN_CCA_END") ??
    optionalTimestampInput("cca-end-timestamp", "BRACKEN_CCA_END");

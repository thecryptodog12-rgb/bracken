...
interface IE3Program {
    ...
    /// @dev This function is called by the Bracken contract during E3 request to configure the computation
    ...
    /// @dev This function is called by the Bracken contract when ciphertext output is published
    /// @param e3Id ID of the E3 computation

 ...
 */
contract BrackenTicketToken is
    ERC20,
    ERC20Votes,
    Ownable2Step,
    ERC20Wrapper,
    ReentrancyGuard
{
    ...
    /**
     * @notice Initializes the Bracken Ticket Token with name "Bracken Ticket Token" and symbol "tBRACKEN"
    ...
    constructor(
        ...
        ERC20("Bracken Ticket Token", "tBRACKEN")
        EIP712("Bracken Ticket Token", "1")

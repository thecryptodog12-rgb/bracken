...
// keccak256(abi.encode(uint256(keccak256("bracken.storage.BondingSlashing")) - 1)) & ~bytes32(uint256(0xff))
...
abstract contract BondingSlashingStorage {
    /// @custom:storage-location erc7201:bracken.storage.BondingSlashing
    struct Layout {
        ...
        mapping(address manager => mapping(uint256 e3Id => address bracken)) e3Bracken;

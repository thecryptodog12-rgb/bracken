...
import { Slashing, Sortition } from '@bracken/diagrams'
          ...
          <div className='opsteps'>
              ...
              {!wallet.available ? (
                ...
                <>
                  ...
                  {!wallet.onCorrectChain && (
                    <>
                      <Note kind='warn'>Bracken is deployed on Sepolia. Switch networks to continue.</Note>
            ...
            >
              ...
              <div className='opactions'>
                ...
                >
                  {label('bondCiphernode', 'Bond BRACKEN')}
                </button>
              </div>

  ...
  return (
    <div className='evlog-wrap'>
      ...
      <div className='evlog__foot'>
        <span>Events stream live from the Bracken contract on Sepolia.</span>
        <a className='link-inline' href={explorerAddress(CONTRACTS.Bracken) + '#events'} target='_blank' rel='noreferrer'>
    ...
    <div className='inspector'>
      ...
      <section className='insp-head'>
        ...
        <div className='insp-stats'>
          ...
          <div className='insp-stat'>
            ...
            <div className='insp-stat__sub'>held by Bracken</div>
          </div>
        </div>
      </section>
      ...
      <SectionCard eyebrow='07 · Fees & settlement' title='Fees'>
        <div className='fees'>
          ...
          />
          <p className='isection__lede'>
            Fee escrowed is the amount currently held by the Bracken contract for this E3; it is released to the committee and any refund on

...
import { BallotPrivacy, KeyShares, Lifecycle, TrustLadder } from '@bracken/diagrams'
  ...
  return (
    <header className={`site-head site-head--${density}`}>
      <div className='site-head__inner'>
        ...
        <a className='wordmark' href={LINKS.site} aria-label='Bracken home'>
          <Wordmark />
        </a>
  ...
  return (
    <footer className='site-foot'>
      ...
      <div className='site-foot__rule'>
        <span>© 2026 Bracken · Built in the open</span>
      ...
      {view === 'ops' ? (
        ...
        <>
          ...
          <Hero
            ...
            lede='Bracken runs computations that nobody — not the requester, not a ciphernode, not whoever operates the network — can read the inputs of. What comes out is a single verified result, and a proof that it was produced correctly.'
            stats={[

...
//
// It reads Bracken's own deployment on chain 4663. Until that exists there is
          ...
          <article key={res.target.key} className='vaudit__net'>
            ...
            {res.target.bracken === null ? (
              <p className='vaudit__err'>
                ...
                of anything to have a finding about. Deploy, set <code>VITE_BRACKEN_ADDRESS</code>, and this page starts answering.
              </p>
            ) : res.error ? (
              <p className='vaudit__err'>

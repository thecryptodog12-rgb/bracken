...
// Demo mode.
//
// Niets van Loxley staat op keten 4663, dus het dashboard leest lege adressen
...
//
// Zodra VITE_LOXLEY_ADDRESS een echt adres is, valt dit bestand volledig stil.
...
export const DEMO = !isSet(CONTRACTS.Loxley)

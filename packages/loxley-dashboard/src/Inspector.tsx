  ...
  return (
    <div className='evlog-wrap'>
      ...
      <div className='evlog__foot'>
        <span>Events stream live from the Loxley contract on Sepolia.</span>
        <a className='link-inline' href={explorerAddress(CONTRACTS.Loxley) + '#events'} target='_blank' rel='noreferrer'>
      ...
      <section className='insp-head'>
        ...
        <div className='insp-stats'>
          ...
          <div className='insp-stat'>
            ...
            <div className='insp-stat__sub'>held by Loxley</div>
          </div>
        </div>
      </section>

...
Shared build tooling configuration for the Bracken monorepo. This is an **internal package** — it
...
```json
{
  "extends": "@bracken/config/tsconfig.json",
  "compilerOptions": {
    "outDir": "dist"
  },
  "include": ["src"]
...
```ts
export { default } from '@bracken/config/tsup'
```

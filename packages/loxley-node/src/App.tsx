  ...
  return (
    <header className='site-head'>
      <div className='site-head__inner'>
        <button className='wordmark' type='button' aria-label='Loxley node overview' onClick={() => navigate('overview')}>
          <span />
        </button>
      ...
      {!snapshot.data ? (
        ...
        <>
          ...
          <footer className='site-foot'>
            ...
            <span className='mono'>Loxley {snapshot.data.node.version}</span>
          </footer>
        </>
      )}
    </div>

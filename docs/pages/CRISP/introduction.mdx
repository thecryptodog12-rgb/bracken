...
[Loxley repository](https://github.com/theloxley/loxley/tree/main/examples/CRISP), follows a modern
...
The [client](https://github.com/theloxley/loxley/tree/main/examples/CRISP/client) is a React
...
The [server](https://github.com/theloxley/loxley/tree/main/examples/CRISP/server) is a Rust-based
...
The [FHE program](https://github.com/theloxley/loxley/tree/main/examples/CRISP/program) is a Rust
...
[Noir circuits](https://github.com/theloxley/loxley/tree/main/examples/CRISP/circuits) provide
...
[main circuit implementation](https://github.com/theloxley/loxley/blob/main/examples/CRISP/circuits/bin/crisp/src/main.nr).
...
[CRISPProgram.sol](https://github.com/theloxley/loxley/tree/main/examples/CRISP/packages/crisp-contracts/contracts/CRISPProgram.sol),
...
The
[CRISPVerifier.sol](https://github.com/theloxley/loxley/tree/main/examples/CRISP/packages/crisp-contracts/contracts/verifiers/CRISPVerifier.sol)
...
The [CRISP SDK](https://github.com/theloxley/loxley/tree/main/examples/CRISP/packages/crisp-sdk) is
...
- [vote masking](https://blog.theloxley.com/vote-masking-receipt-freeness-secret-ballots/)

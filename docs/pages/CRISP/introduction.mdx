...
import { BallotPrivacy } from '@bracken/diagrams'
...
[Bracken repository](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP),
...
├── bracken.config.yaml      # Ciphernodes + aggregator config
└── docker-compose.yaml      # Optional multi-node deployment
```

### Client Application

The [client](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/client) is a
React application built with TypeScript that provides the user a voting interface. It uses the CRISP
...
The [server](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/server) is a
...
The [FHE program](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/program) is
a Rust guest program that runs inside the RISC Zero zkVM to perform homomorphic addition on
...
[Noir circuits](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/circuits)
...
[main circuit implementation](https://github.com/thecryptodog12-rgb/bracken/blob/main/examples/CRISP/circuits/bin/crisp/src/main.nr).
...
[CRISPProgram.sol](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/packages/crisp-contracts/contracts/CRISPProgram.sol),
...
The
[CRISPVerifier.sol](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/packages/crisp-contracts/contracts/verifiers/CRISPVerifier.sol)
...
The
[CRISP SDK](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/packages/crisp-sdk)
...
complete reference implementation for developers building with the Bracken.

...
[crisp-zk-inputs README](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP/packages/crisp-zk-inputs)
for the full API.
...
you can reuse the user-data-encryption circuit and the standard Bracken SDK.

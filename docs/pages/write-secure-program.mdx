...
Ciphernode Committee. To facilitate this, Loxley provides a
[Compute Provider package](https://github.com/theloxley/loxley/tree/main/crates/compute-provider) to
simplify writing the Secure Process with any Compute Provider.

### Using the Compute Provider Package

To simplify integration with the Loxley, use the provided Compute Provider package.
...
- The [`InputPolicy`](https://github.com/theloxley/loxley/tree/main/crates/compute-provider) your E3
  program exports, which decides the leaf layout and which inputs are computed over.

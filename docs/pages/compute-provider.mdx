...
Compute Providers form the modular compute layer of the Bracken protocol, allowing you to choose the
...
- You can also implement your own custom CP. From Bracken's perspective, it simply requires a
...
Bracken provides a
[Compute Provider package](https://github.com/thecryptodog12-rgb/bracken/tree/main/crates/compute-provider)
...
3. (Optional) Get a Pinata JWT from [pinata.cloud](https://pinata.cloud) for uploading programs to
   IPFS
4. Configure your `bracken.config.yaml` as shown in the

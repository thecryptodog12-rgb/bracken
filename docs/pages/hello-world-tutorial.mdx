...
- [Loxley CLI installed](/installation)
...
├── loxley.config.yaml # Loxley configuration
...
The `loxley.config.yaml` file configures your development environment:
...
2. **Submission**: Publish encrypted data to the Loxley contract
3. **Result retrieval**: Get the decrypted result from the Loxley contract
...
Happy building with the Loxley! 🚀

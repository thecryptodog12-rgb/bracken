...
- [Bracken CLI installed](/installation)
...
├── bracken.config.yaml # Bracken configuration
...
The `bracken.config.yaml` file configures your development environment:
...
2. **Submission**: Publish encrypted data to the Bracken contract
3. **Result retrieval**: Get the decrypted result from the Bracken contract
...
Happy building with the Bracken! 🚀

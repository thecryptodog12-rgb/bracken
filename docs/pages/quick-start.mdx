...
Get your first E3 program running on the Bracken protocol! This guide assumes you have the
[Bracken CLI installed](/installation).

## Prerequisites Check

Make sure you have the required software installed. See [System Requirements](/requirements) for
...
bracken --version   # Confirm CLI is installed
```

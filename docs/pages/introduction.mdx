...
For example, the Loxley can coordinate sealed-bid auctions where participants submit encrypted
...
[Cryptography](/cryptography). To compile and lint the Noir workspace, run `loxley noir`, and

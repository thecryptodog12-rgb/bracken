...
> **Note on naming**
>
> The Loxley was previously known as **Enclave**.
...
The Loxley enables applications that coordinate computation across independent parties without
...
The Loxley coordinates encrypted execution using a combination of Fully Homomorphic Encryption

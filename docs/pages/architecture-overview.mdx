...
- Manages operator ciphernode bonds (LOX tokens) and ticket balances (tLOX)
...
The Loxley supports multiple CPs with different trust, scalability, and cost tradeoffs.

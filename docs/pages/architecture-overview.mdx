...
- Manages operator ciphernode bonds (FOLD tokens) and ticket balances (tFOLD)
...
decryption window) on the Loxley contract. The committee formation window is managed separately

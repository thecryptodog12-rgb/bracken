...
1. **Define the E3 Program**: Author your Secure Process using the tooling described in
   [Writing the Secure Process](/write-secure-program). The Loxley currently ships first-party
...
2. **Publish Output**: The ciphertext output and accompanying proof are submitted to the Loxley
   contract via `publishCiphertextOutput`. The Loxley contract calls your E3 Program's `verify`

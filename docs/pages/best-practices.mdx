...
- **Key hygiene**: `dev:setup` wipes `.bracken` directories for you; mimic that behavior in
...
2. Execute integration tests that cover `request → publishInput → publishCiphertextOutput` with mock
   proofs.
3. Verify wallet funding for any automation (bracken CLI, Hardhat deployers).

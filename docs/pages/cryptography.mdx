...
title: 'Cryptography'
description:
  'Threshold BFV, zero-knowledge circuits, and how they map to the Bracken implementation'
---

import { KeyShares, TrustLadder } from '@bracken/diagrams'
...
This page is a guided tour of the **cryptographic foundations** behind the Bracken: how **threshold
...
ran the right steps. Bracken design pushes in a different direction, often summarised as the
...
- **P2 — Public key aggregation** is deliberately short: someone acting as aggregator sums the
  ...
  [**C5**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_aggregation)
...
- **P3 — User encryption** is where data providers enter. They encrypt under the aggregated
  ...
  [`user_data_encryption_ct0`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/user_data_encryption_ct0),
  [`user_data_encryption_ct1`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/user_data_encryption_ct1),
  and
  [`user_data_encryption`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/user_data_encryption)
...
- **P4 — Threshold decryption** closes the loop after homomorphic evaluation. Ciphernodes in **A**
  ...
  [**C6**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/share_decryption)
  and
  [**C7**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/decrypted_shares_aggregation)
...
[`circuits/bin/config`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/config))
...
logs, and the
[`circuits/README.md`](https://github.com/thecryptodog12-rgb/bracken/blob/main/circuits/README.md)
index.

| Phase                    | Circuits                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | What you are looking at                                                                                       |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| **Config**               | [`config`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/config)                                                                                                                                                                                                                                                                                                                                                                                                                          | One-time consistency of presets before any E3.                                                                |
| **P1 — DKG**             | [**C0**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/pk), [**C1**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_generation), [**C2**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/sk_share_computation), [**C3**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_encryption), [**C4**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_decryption) | Individual pk; TrBFV contribution; Shamir + parity (recursive **C2**); encrypt shares; decrypt and aggregate. |
| **P2 — Aggregation**     | [**C5**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_aggregation)                                                                                                                                                                                                                                                                                                                                                                                                          | Sum honest public key shares into the threshold pk.                                                           |
| **P3 — User encryption** | [`user_data_encryption_*`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/user_data_encryption_ct0)                                                                                                                                                                                                                                                                                                                                                                              | Valid BFV encryption under the aggregated key.                                                                |
| **P4 — Decryption**      | [**C6**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/share_decryption), [**C7**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/decrypted_shares_aggregation)                                                                                                                                                                                                                                                                                 | Partial decryptions; Lagrange combination, CRT lift, decode to plaintext.                                     |
...
[**C1**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_generation)
living under
[`circuits/bin/threshold`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold)
and the rest of the DKG chain under
[`circuits/bin/dkg`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg)).
...
[`circuits/lib/src/math/safe.nr`](https://github.com/thecryptodog12-rgb/bracken/blob/main/circuits/lib/src/math/safe.nr)),
...
[**C5**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_aggregation),
and how
[**C4**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_decryption)
hands off to
[**C6**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/share_decryption),
without ever dumping raw polynomials into calldata. Domain labels (`DS_*` in
[`commitments.nr`](https://github.com/thecryptodog12-rgb/bracken/blob/main/circuits/lib/src/math/commitments.nr))
...
[**C2**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/sk_share_computation)'s
expected commitments match
[**C1**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_generation)'s
...
1. **DKG recursive proof**: the aggregator recursively verifies every node's C0–C4 fold chain
   ...
   [`BfvPkVerifier`](https://github.com/thecryptodog12-rgb/bracken/blob/main/packages/bracken-contracts/contracts/verifiers/bfv/BfvPkVerifier.sol)
   at `publishCommittee`.
2. **Decryption recursive proof**: the aggregator recursively verifies **C6** proofs from at least
   **T+1** parties together with **C7**, which reconstructs the plaintext. Verified on-chain by
   [`BfvDecryptionVerifier`](https://github.com/thecryptodog12-rgb/bracken/blob/main/packages/bracken-contracts/contracts/verifiers/bfv/BfvDecryptionVerifier.sol)
...
[`DkgFoldAttestationVerifier`](https://github.com/thecryptodog12-rgb/bracken/blob/main/packages/bracken-contracts/contracts/verifiers/DkgFoldAttestationVerifier.sol)
...
[`SlashingManager.proposeSlash`](https://github.com/thecryptodog12-rgb/bracken/blob/main/packages/bracken-contracts/contracts/slashing/SlashingManager.sol)
...
| Term                                    | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Individual key pair**                 | Per-node BFV keys used **only** to encrypt **Shamir shares** in transit during DKG. [**C0**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/pk) commits the individual public key; [**C3**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_encryption) binds encryption to that commitment.                                                                              |
| **Secret key contribution**             | One node’s additive piece of the threshold secret **before** Shamir splitting in the usual DKG story.                                                                                                                                                                                                                                                                                                                              |
| **Public key share**                    | The TrBFV public material for that contribution; [**C1**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_generation) proves BFV keygen relations; [**C5**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_aggregation) sums these shares.                                                                                                                    |
| **Secret key share**                    | After P1, a node’s **Shamir** share of the threshold secret (not the same as “contribution”).                                                                                                                                                                                                                                                                                                                                      |
| **Threshold public key**                | The BFV key users encrypt to after [**C5**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_aggregation); no single party holds the full matching secret.                                                                                                                                                                                                                                        |
| **Smudging noise**                      | Noise shared across parties so decryption shares do not leak **sk**; **e_sm** in Noir; proved in [**C1**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/pk_generation)–[**C4**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_decryption) and used in [**C6**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/share_decryption). |
| **Smudging noise contribution / share** | Per-node piece of smudging material and its Shamir shares, parallel to the secret-key track ([**C2**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/sk_share_computation) / [**C3**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_encryption) / [**C4**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_decryption) smudging track).  |
...
[**C2**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/sk_share_computation)
ships inside the secure preset that
[`config`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/config) checks.
...
[**C0**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/pk) (`dkg/pk`)
commits that key, and later
[**C3**](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/dkg/share_encryption)
...
[`user_data_encryption_ct1`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/user_data_encryption_ct1),
and
[`user_data_encryption`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/threshold/user_data_encryption)—following
...
[`recursive_aggregation/`](https://github.com/thecryptodog12-rgb/bracken/tree/main/circuits/bin/recursive_aggregation);
...
[DKG & computation](https://github.com/thecryptodog12-rgb/bracken/blob/main/agent/flow-trace/04_DKG_AND_COMPUTATION.md)

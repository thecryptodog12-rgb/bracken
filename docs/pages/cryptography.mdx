...
title: 'Cryptography'
description:
  'Threshold BFV, zero-knowledge circuits, and how they map to the Loxley implementation'
---

## Cryptography

This page is a guided tour of the **cryptographic foundations** behind the Loxley: how
...
[`circuits/bin/config`](https://github.com/theloxley/loxley/tree/main/circuits/bin/config))
...
living under
[`circuits/bin/threshold`](https://github.com/theloxley/loxley/tree/main/circuits/bin/threshold)
...
[**C5**](https://github.com/theloxley/loxley/tree/main/circuits/bin/threshold/pk_aggregation),
and how
[**C4**](https://github.com/theloxley/loxley/tree/main/circuits/bin/dkg/share_decryption)
hands off to
[**C6**](https://github.com/theloxley/loxley/tree/main/circuits/bin/threshold/share_decryption),
...
[**C0**](https://github.com/theloxley/loxley/tree/main/circuits/bin/dkg/pk) (`dkg/pk`) commits
that key, and later
...
this page: the
[`circuits/README.md`](https://github.com/theloxley/loxley/blob/main/circuits/README.md) index

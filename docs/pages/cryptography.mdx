...
1. **DKG recursive proof**: the aggregator recursively verifies every node's C0–C4 fold chain
   ...
   [`BfvPkVerifier`](https://github.com/thecryptodog12-rgb/loxley/blob/main/packages/bracken-contracts/contracts/verifiers/bfv/BfvPkVerifier.sol)
   at `publishCommittee`.
2. **Decryption recursive proof**: the aggregator recursively verifies **C6** proofs from at least
   **T+1** parties together with **C7**, which reconstructs the plaintext. Verified on-chain by
   [`BfvDecryptionVerifier`](https://github.com/thecryptodog12-rgb/loxley/blob/main/packages/bracken-contracts/contracts/verifiers/bfv/BfvDecryptionVerifier.sol)
...
[`DkgFoldAttestationVerifier`](https://github.com/thecryptodog12-rgb/loxley/blob/main/packages/bracken-contracts/contracts/verifiers/DkgFoldAttestationVerifier.sol)
...
[`SlashingManager.proposeSlash`](https://github.com/thecryptodog12-rgb/loxley/blob/main/packages/bracken-contracts/contracts/slashing/SlashingManager.sol)

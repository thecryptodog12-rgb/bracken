...
| ----------- | -------------------------------------------------- | ------------ |
| **LOXLEY**  | Ciphernode bond - required to register             | Yes          |
| **tLOXLEY** | Ticket token - determines committee selection odds | No           |
...
2. Mints equivalent tLOXLEY to the operator address
3. Re-evaluates the operator's active status

To buy tickets from a wallet instead of the CLI, use step 5 of the
[interactive operator guide](https://loxley-dashboard-solplay.vercel.app/#operator). It prices the
...
| `isActive` is false             | Below minimum tickets or ciphernode bond | Top up tickets or bond more LOXLEY |

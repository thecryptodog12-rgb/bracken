...
| ------------------------- | -------------------- | ------------ |
| Loxley                    | `0xTBD_NOT_DEPLOYED` | 25786382     |
| CiphernodeRegistry        | `0xTBD_NOT_DEPLOYED` | 25786378     |
| BondingRegistry           | `0xTBD_NOT_DEPLOYED` | 25473398     |
| SlashingManager           | `0xTBD_NOT_DEPLOYED` | 25786375     |
| E3RefundManager           | `0xTBD_NOT_DEPLOYED` | 25786384     |
| LoxleyTicketToken         | `0xTBD_NOT_DEPLOYED` | 25786372     |
| LoxleyToken (LOXLEY)      | `0xTBD_NOT_DEPLOYED` | 25473449     |
| USDS (fee token)          | `0xTBD_NOT_DEPLOYED` | 20663730     |
| sUSDS (ticket collateral) | `0xTBD_NOT_DEPLOYED` | 20677434     |
...
| Contract             | Address              | Deploy block |
| -------------------- | -------------------- | ------------ |
| Loxley               | `0xTBD_NOT_DEPLOYED` | 11459000     |
| CiphernodeRegistry   | `0xTBD_NOT_DEPLOYED` | 11458978     |
| BondingRegistry      | `0xTBD_NOT_DEPLOYED` | 11458979     |
| SlashingManager      | `0xTBD_NOT_DEPLOYED` | 11458977     |
| E3RefundManager      | `0xTBD_NOT_DEPLOYED` | 11459002     |
| LoxleyTicketToken    | `0xTBD_NOT_DEPLOYED` | 11458976     |
| LoxleyToken (LOXLEY) | `0xTBD_NOT_DEPLOYED` | 11458986     |
| MockUSDC (fee token) | `0xTBD_NOT_DEPLOYED` | 11458975     |
| Faucet               | `0xTBD_NOT_DEPLOYED` | 11458989     |
...
| -------------------------------- | -------------------------------------------- | ------------ |
| MockE3Program                    | `0xTBD_NOT_DEPLOYED`                         | 25786371     |
...
| ---------------------- | -------------------- | ------------ |
| MockE3Program          | `0xTBD_NOT_DEPLOYED` | 11458997     |
| MockComputeProvider    | `0xTBD_NOT_DEPLOYED` | 11458993     |
| MockDecryptionVerifier | `0xTBD_NOT_DEPLOYED` | 11458994     |
| MockCiphertextVerifier | `0xTBD_NOT_DEPLOYED` | 11458995     |
| MockPkVerifier         | `0xTBD_NOT_DEPLOYED` | 11458996     |

...
The Loxley smart contract acts as the central coordinator for all E3 operations. It manages
...
The Loxley contract exposes these read-only functions for querying E3 state:
...
The Loxley uses a Lean Merkle Tree implementation. Each input is hashed using the PoseidonT3 Hash
...
2. The Loxley uses the E3 Program contract to verify the proof and emits
...
The Loxley protocol will accept and decrypt whatever output is reported by your Compute Provider. In

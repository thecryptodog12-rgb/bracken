...
Loxley smart contract acts as the central coordinator for all E3 operations. It manages
...
2. Loxley uses the E3 Program contract to verify the proof and emits

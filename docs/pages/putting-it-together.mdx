...
import {IBracken, IE3Program} from "@bracken/contracts/interfaces/IBracken.sol";
...
- Deploy the Bracken contracts to your desired network.
- Deploy your E3 Program contract and register it with the Bracken contract.

### Step 6: Run Ciphernodes

- Start Ciphernodes and ensure they are registered with the Bracken contract.

### Step 7: Submit a Computation Request

- Use your application or a script to submit a computation request to the Bracken contract.

**Example (JavaScript):**

```javascript
// First approve the fee token
await FeeTokenContract.approve(BrackenContract.address, computationFee)

// Then request the E3
await BrackenContract.request(
...
- Retrieve the plaintext result from the Bracken contract.

---

## Conclusion

By following this guide, you should now have a solid understanding of the Bracken and how to build
your own E3 Programs. Bracken provides a framework for privacy-preserving computations over
encrypted data, enabling a new class of decentralized applications.

**Key Takeaways:**

- Bracken distributes trust and ensures data remains encrypted throughout computation.
...
- **Bracken GitHub Repository**:
  [https://github.com/thecryptodog12-rgb/bracken](https://github.com/thecryptodog12-rgb/bracken)
- **CRISP GitHub Repository**:
  [https://github.com/thecryptodog12-rgb/bracken](https://github.com/thecryptodog12-rgb/bracken/tree/main/examples/CRISP)
- **Bracken Quick Start**: [Quick Start](/quick-start)
- **RISC Zero Documentation**: [https://www.risczero.com](https://www.risczero.com)
- **Compute Provider Package**: Check the Bracken repository for the Compute Provider package and
  examples.
...
[the Bracken repository](https://github.com/thecryptodog12-rgb/bracken/issues).

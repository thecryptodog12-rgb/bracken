...
import {ILoxley, IE3Program} from "@loxley/contracts/interfaces/ILoxley.sol";
...
- Deploy the Loxley contracts to your desired network.
- Deploy your E3 Program contract and register it with the Loxley contract.

### Step 6: Run Ciphernodes

- Start Ciphernodes and ensure they are registered with the Loxley contract.

### Step 7: Submit a Computation Request

- Use your application or a script to submit a computation request to the Loxley contract.

**Example (JavaScript):**

```javascript
// First approve the fee token
await FeeTokenContract.approve(LoxleyContract.address, computationFee)

// Then request the E3
await LoxleyContract.request(
  0, // CommitteeSize.Minimum
  [inputWindowStart, inputWindowEnd],
  e3ProgramAddress,
  0, // paramSet (0 = insecure dev, 1 = secure production)
...
- Retrieve the plaintext result from the Loxley contract.

---

## Conclusion

By following this guide, you should now have a solid understanding of the Loxley and how to build
your own E3 Programs. Loxley provides a framework for privacy-preserving computations over encrypted
data, enabling a new class of decentralized applications.

**Key Takeaways:**

- Loxley distributes trust and ensures data remains encrypted throughout computation.
...
- **Loxley GitHub Repository**:
  [https://github.com/thecryptodog12-rgb/interfold](https://github.com/thecryptodog12-rgb/interfold)
- **CRISP GitHub Repository**:
  [https://github.com/thecryptodog12-rgb/interfold](https://github.com/thecryptodog12-rgb/interfold/tree/rebrand/loxley/examples/CRISP)
- **Loxley Quick Start**: [Quick Start](/quick-start)
- **RISC Zero Documentation**: [https://www.risczero.com](https://www.risczero.com)
- **Compute Provider Package**: Check the Loxley repository for the Compute Provider package and
  examples.
...
If you have any questions or need further assistance, open an issue on
[the Loxley repository](https://github.com/thecryptodog12-rgb/interfold/issues).

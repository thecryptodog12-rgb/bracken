...
[`circuits/README.md`](https://github.com/theloxley/loxley/blob/main/circuits/README.md) in
...
The CLI keeps this copy under `~/.loxley/noir` instead of on your `PATH`, so
`loxley noir status` is what reports the installed version.

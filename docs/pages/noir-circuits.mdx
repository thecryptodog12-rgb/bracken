...
[`agent/flow-trace/04_DKG_AND_COMPUTATION.md`](https://github.com/theloxley/loxley/blob/main/agent/flow-trace/04_DKG_AND_COMPUTATION.md).

The canonical **package index** (paths, **CircuitName**, C0–C7 IDs) is
[`circuits/README.md`](https://github.com/theloxley/loxley/blob/main/circuits/README.md) in the
...
```toml
[dependencies]
loxley_lib = { git = "https://github.com/theloxley/loxley", tag = "v0.2.2", directory = "circuits/lib" }
```
...
[`scripts/README.md`](https://github.com/theloxley/loxley/blob/main/scripts/README.md#circuit-builder)
and
[`circuits/benchmarks/README.md`](https://github.com/theloxley/loxley/blob/main/circuits/benchmarks/README.md).

...
```bash
nix develop github:thecryptodog12-rgb/loxley/{branch,tag,commit}
```
...
```bash
❯ nix develop github:thecryptodog12-rgb/loxley/v0.2.2
❯ bracken --version
bracken 0.2.2
❯ bb --version
...
1. Visit the [releases page](https://github.com/thecryptodog12-rgb/loxley/releases)

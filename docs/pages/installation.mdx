...
```bash
nix develop github:thecryptodog12-rgb/interfold/{branch,tag,commit}
```
...
```bash
❯ nix develop github:thecryptodog12-rgb/interfold/v0.2.2
❯ loxley --version
loxley 0.2.2
❯ bb --version
...
1. Visit the [releases page](https://github.com/thecryptodog12-rgb/interfold/releases)

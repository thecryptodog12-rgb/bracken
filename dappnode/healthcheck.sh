...
PASSWORD_FILE="${PASSWORD_FILE:-/data/.bracken/config/_default/key}"
DB_PATH="${DB_PATH:-/data/.bracken/data/_default/db}"
EVENT_LOG_PATH="${EVENT_LOG_PATH:-/data/.bracken/data/_default/log.0}"
...
[ "$(basename "$(readlink "$PROC_ROOT/1/exe")")" = "bracken" ] || exit 1

...
pub enum Commands {
    ...
    Init {
        ...
        /// Template repository to use. Expecting the form `git+https://github.com/thecryptodog12-rgb/interfold.git#main:template/default`
        #[arg(long)]
    ...
    /// Request testnet tokens (LOXLEY + fee token) from the configured faucet
    Faucet {
        #[command(flatten)]
        chain: ChainArgs,
    },

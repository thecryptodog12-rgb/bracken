...
const PROTOCOL_NAME: StreamProtocol = StreamProtocol::new("/bracken/kad/1.0.0");
...
fn create_behaviour(
    ...
    let identify = IdentifyBehaviour::new(
        IdentifyConfig::new("/bracken/0.0.1".into(), key.public())
    ...
    let request_response = cbor::Behaviour::<Vec<u8>, ProtocolResponse>::new(
        [(
            StreamProtocol::new("/bracken/sync/0.0.1"),

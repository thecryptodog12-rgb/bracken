...
```
ERROR! event=BrackenError(BrackenError { err_type: Evm, message: "deserialization error: duplicate field `status` at line 1 column 34542" })
```
...
```
bracken start -v --otel http://localhost:4317
```

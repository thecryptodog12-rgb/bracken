...
pub const DEFAULT_CONFIG_NAME: &str = "bracken.config.yaml";
...
// data and config folders under .bracken/data and .bracken/config relative to the location of
...
impl PathsEngine {
    ...
    fn get_root_dir(&self) -> Option<PathBuf> {
        if let Some(file) = self.found_config_file.clone() {
            if let Some(parent) = file.parent() {
                return Some(PathBuf::from(parent).join(".bracken"));
            }
        }
        None
    }
    ...
    fn get_noir_base(&self) -> PathBuf {
        ...
        // Fallback to .bracken relative to default config dir (e.g., ~/.config/bracken/.bracken)
        self.default_config_dir.join(".bracken")
    }
...
mod test {
        ...
        test_cases(vec![
            TestCase {
                ...
                input: PathsInput {
                    name: "_default",
                    cwd: "/no/matter",
                    default_data_dir: "/home/user/.local/share/bracken",
                    default_config_dir: "/home/user/.config/bracken",
                ...
                expected: PathsExpected {
                    config_file: "/home/user/.config/bracken/bracken.config.yaml",
                    key_file: "/home/user/.config/bracken/_default/key",
                    db_file: "/home/user/.local/share/bracken/_default/db",
                    log_file: "/home/user/.local/share/bracken/_default/log",
                    bb_file: "/home/user/.config/bracken/.bracken/noir/bin/bb",
                    noir_dir: "/home/user/.config/bracken/.bracken/noir",
                    circuits_dir: "/home/user/.config/bracken/.bracken/noir/circuits",
                    work_dir: "/home/user/.config/bracken/.bracken/noir/work/_default",
                },
            },
            TestCase {
                ...
                input: PathsInput {
                    name: "_default",
                    cwd: "/no/matter",
                    default_data_dir: "/home/user/.local/share/bracken/data",
                    default_config_dir: "/home/user/.config/bracken/config",
                    config_dir_override: None,
                ...
                expected: PathsExpected {
                    ...
                    key_file: "/foo/.bracken/config/_default/key",
                    db_file: "/foo/.bracken/data/_default/db",
                    log_file: "/foo/.bracken/data/_default/log",
                    bb_file: "/foo/.bracken/noir/bin/bb",
                    noir_dir: "/foo/.bracken/noir",
                    circuits_dir: "/foo/.bracken/noir/circuits",
                    work_dir: "/foo/.bracken/noir/work/_default",
                },
            },
            TestCase {
    ...
    fn test_is_default_config_file() {
        let default_data_dir = PathBuf::from("/home/user/.local/share/bracken");
        let default_config_dir = PathBuf::from("/home/user/.config/bracken");
        ...
        let paths = PathsEngine::new(
            ...
            &default_config_dir,
            Some(&PathBuf::from(
                "/home/user/.config/bracken/bracken.config.yaml",
            )),
            None,
            None,
            None,

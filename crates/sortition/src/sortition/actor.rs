...
use e3_events::{
    ...
    EventContext, EventType, BrackenEvent, OperatorActivationChanged, PlaintextOutputPublished,
    Seed, Sequenced, TicketBalanceUpdated, TypedEvent,
};
use e3_events::{BusHandle, E3id, BrackenEventData};
...
pub struct Sortition {
    ...
    /// Event bus for error reporting and bracken event subscription.
    bus: BusHandle,

...
- [`Snapshot`](https://github.com/thecryptodog12-rgb/bracken/blob/main/crates/data/src/snapshot.rs) for
  defining how an object can create a snapshot of it's state
- [`Checkpoint`](https://github.com/thecryptodog12-rgb/bracken/blob/main/crates/data/src/snapshot.rs) for
  defining how to save that snapshot to a repository
- [`FromSnapshot`](https://github.com/thecryptodog12-rgb/bracken/blob/main/crates/data/src/snapshot.rs) and
  [`FromSnapshotWithParams`](https://github.com/thecryptodog12-rgb/bracken/blob/main/crates/data/src/snapshot.rs)
...
[`StoreKeys`](https://github.com/thecryptodog12-rgb/bracken/blob/main/crates/events/src/store_keys.rs) struct.
This is used in various places when creating repsitory factories for example
[here](https://github.com/thecryptodog12-rgb/bracken/blob/main/crates/aggregator/src/repo.rs)

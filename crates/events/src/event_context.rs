...
use crate::{
    E3id, EventContextAccessors, EventContextSeq, EventId, BrackenEventData, SeqState, Sequenced,
    Unsequenced,
};
...
impl From<BrackenEventData> for EventContext<Unsequenced> {
    fn from(value: BrackenEventData) -> Self {

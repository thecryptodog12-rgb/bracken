...
use crate::{
    E3id, EventContextAccessors, EventContextSeq, EventId, LoxleyEventData, SeqState, Sequenced,
    Unsequenced,
};
...
impl From<LoxleyEventData> for EventContext<Unsequenced> {
    fn from(value: LoxleyEventData) -> Self {

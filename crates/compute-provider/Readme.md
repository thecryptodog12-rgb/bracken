...
[Bracken Protocol](https://theinterfold.com). It supports both sequential and parallel processing, with
...
```toml
[dependencies]
e3-compute-provider = { git = "https://github.com/thecryptodog12-rgb/bracken.git", path = "crates/compute-provider"}
```

...
```toml
[dependencies]
polynomial = { git = "https://github.com/gnosisguild/loxley", path = "crates/polynomial" }
```
...
```toml
[dependencies]
polynomial = { git = "https://github.com/gnosisguild/loxley", path = "crates/polynomial", features = ["serde"] }
```

...
```toml
[dependencies]
polynomial = { git = "https://github.com/thecryptodog12-rgb/interfold", path = "crates/polynomial" }
```
...
```toml
[dependencies]
polynomial = { git = "https://github.com/thecryptodog12-rgb/interfold", path = "crates/polynomial", features = ["serde"] }
```

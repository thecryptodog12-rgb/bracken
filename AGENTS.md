...
2. `agent/CONTEXT.md` — what Bracken is: terminology, monorepo map, commands, conventions
...
- `packages/bracken-mcp/` — implementation of the `bracken-docs` MCP server
